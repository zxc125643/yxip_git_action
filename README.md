...
- `OUTPUT_WITH_REMARKS=true`：开启纯净度时按 `ip#地区 纯净度` 格式输出；设为 `false` 可退回纯 IP。
...
开启纯净度后，`ip.txt` 和 `ip_clean.txt` 默认输出示例：

```txt
104.17.175.237#美国-California-San Francisco 极度纯净 5.0
172.67.174.74#加拿大-Ontario-Toronto 纯净 4.8
```
